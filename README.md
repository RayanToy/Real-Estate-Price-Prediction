...
Этот проект представляет собой комплексное исследование данных о рынке недвижимости с целью выявления ключевых факторов, влияющих на стоимость квартир, и построения предиктивной модели машинного обучения. Анализ выполнен на наборе данных, содержащем объявления о продаже квартир в нескольких крупных городах России.
...
4.  **Оптимизация и финальная модель**:
    ...
    *   Оптимизация позволила достичь на отложенной тестовой выборке значения метрики **R² ≈ 0.88**, что свидетельствует о высокой предсказательной силе итоговой модели.
